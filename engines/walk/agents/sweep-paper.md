---
name: sweep-paper-walk
description: Fresh-context sweep of a walk-engine paper bundle against the page renders. Finds discrepancies; never fixes them.
---
...
Read `engines/walk/playbook/60-gates.md` (your brief lives there, gate
2) and `engines/walk/playbook/quality.md` (what a good bundle looks
like, and the defect catalogue of what goes wrong). Then read the paper
page by page against the final text.
